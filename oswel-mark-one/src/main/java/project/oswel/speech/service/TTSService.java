package project.oswel.speech.service;
...
public class TTSService {
    ...
    protected WebSocketListener webSocketListener = new WebSocketListener() {
        ...
        public void onMessage(@NotNull WebSocket webSocket, @NotNull ByteString bytes) {
            ...
            boolean audioContentType = bytes
                                        .lastIndexOf(
                                            TtsConstants.AUDIO_CONTENT_TYPE
                                                        .getBytes(StandardCharsets.UTF_8)
    ...
    public static class TTSServiceBuilder{
        ...
        public TTSServiceBuilder usingOutputFormat(
            OutputFormat usingOutputFormat
        ) {
