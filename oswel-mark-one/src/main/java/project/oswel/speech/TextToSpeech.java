...
public class TextToSpeech {
	 ...
	 *            <br>
	 *            <b>True</b> 
	 * 					The thread that will start the text to speech 
	 * 					Player will be a daemon Thread <br>
	 *            <b>False</b> 
	 * 					The thread that will start the text to 
	 * 					speech Player will be a normal non daemon Thread
	 * @param join
	 *            <br>
	 *            <b>True</b> 
	 * 					The current Thread calling this 
	 * 					method will wait(blocked) until the Thread 
	 * 					which is playing the Speech finish <br>
	 *            <b>False</b> 
	 * 					The current Thread calling this 
	 * 					method will continue freely after calling this method
	 */
	public void speak(
		String text, 
		float gainValue, 
		...
		try (AudioInputStream audio = marytts.generateAudio(text)) {
			...
			Logger.getLogger(getClass().getName()).log(
				Level.WARNING, "Error saying phrase.", ex);
		} catch (IOException ex) {
			Logger.getLogger(getClass().getName()).log(
				Level.WARNING, "IO Exception", ex);
		} catch (InterruptedException ex) {
			Logger.getLogger(getClass().getName()).log(
				Level.WARNING, "Interrupted ", ex);
			tts.interrupt();
		}
	}
	 ...
	 * @return the marytts
	 */
	public MaryInterface getMarytts() { return marytts; }
	 ...
	 * @param voice
	 */
	public void setVoice(String voice) { marytts.setVoice(voice); }
}