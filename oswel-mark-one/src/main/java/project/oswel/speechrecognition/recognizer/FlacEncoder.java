...
public class FlacEncoder {
    ...
    /**
     * Converts a wave file to a FLAC file(in order to POST the data to 
     * Google and retrieve a response) <br> Sample Rate is 8000 by default
     *
    ...
    public void convertWaveToFlac(File inputFile, File outputFile) {
        ...
        try {
            ...
            FLACFileOutputStream flacOutputStream = new FLACFileOutputStream(
                outputFile
            );
            ...
            flacEncoder.encodeSamples(
                flacEncoder.samplesAvailableToEncode(), true);
    ...
    /**
     * Converts a wave file to a FLAC file(in order to POST the data 
     * to Google and retrieve a response) <br>
    ...
    /**
     * Used for when the frame length is unknown to shorten the 
     * array to prevent huge blank end space 
