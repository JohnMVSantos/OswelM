package project.oswel.speechrecognition.translator;
...
/*******************************************************************************
 * An API for a Google Translation service in Java. Please Note: 
 * This API is unofficial and is not supported by Google. 
 * Subject to breakage at any time. The translator allows for 
 * language detection and translation. Recommended for translation 
 * of user interfaces or speech commands. All translation services 
...
public final class GoogleTranslate { 
	...
	/**
	 * Converts the ISO-639 code into a friendly language code 
	 * in the user's default language For example, if the language 
	 * is English and the default locale is French, it will 
	 * return "anglais" Useful for UI Strings
	 * 
	 * @param languageCode
	 *            The ISO639-1
	...
	private static String generateURL(
		...
		sb.append("&q=");
		sb.append(encoded);
		// Necessary but unknown parameters
		...
		// such as pronunciation, and so on.
		// TODO Modify API so that the user may request this 
	...
	public static String detectLanguage(String text) throws IOException {
		String urlText = generateURL(
			"auto", "en", text);
		// Generates URL
		URL url = new URL(urlText); 
		// Gets text from Google
		String rawData = urlToText(url);
		return findLanguage(rawData);
	}
	
	/**
	 * Automatically translates text to a system's default 
	 * language according to its locale Useful for creating 
	 * international applications as you can
	...
	/**
	 * Automatically detects language and translate to the 
	 * targetLanguage. Allows Google to determine source language
	 * 
	 * @see GoogleTranslate#translate(String, String, String)
	 * @param targetLanguage
	...
	public static String translate(
		String targetLanguage , String text) throws IOException {
		return translate("auto", targetLanguage, text);
	}
	
	/**
	 * Translate text from sourceLanguage to targetLanguage 
	 * Specifying the sourceLanguage greatly improves accuracy 
	 * over short Strings
	 * 
	 * @param sourceLanguage
	...
	private static String urlToText(URL url) throws IOException {
		...
		// Otherwise, Google rejects the request
		urlConn.addRequestProperty(
			"User-Agent", "Mozilla/5.0 " + 
			"(Windows NT 6.1; WOW64; rv:2.0) Gecko/20100101 Firefox/4.0");
		Reader r = new java.io.InputStreamReader(
			// Gets Data Converts to string
	 ...
	 * @return The language parsed from the rawData or 
	 * 		en-US (English-United States) if Google cannot determine it.
	 */
	...
	/**
	 * This function generates the int array for translation 
	 * acting as the seed for the hashing algorithm.
	 */
