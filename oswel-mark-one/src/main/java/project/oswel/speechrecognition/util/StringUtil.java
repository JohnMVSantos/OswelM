...
public class StringUtil {
    ...
    /**
     * Returns the first instance of String found exclusively 
    ...
    public static String substringBetween(
        String s, String part1, String part2) {
    ...
    /**
     * Gets the string exclusively between the first instance of part1 
     * and the last instance of part2.
